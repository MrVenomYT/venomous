...
function darkMode() {
  if (document.getElementById("darkmode").checked == true) {
    ...
    document
      ...
      .classList.replace("errortext", "darkerrortext");
    ...
    document
      .getElementById("error")
      .classList.replace("darkerrortext", "errortext");
...
function updateOutputText(event) {
  ...
  if (format.outputPrefix) {
    ...
    if (nickName.value) {
      ...
      if (!nickName.value.match(letters))
        nickName.value = nickName.value.replace(event.data, "");
      if (!nickName.value.match(letters))
        nickName.value = "venomous.vercel.app";
    }
  }
